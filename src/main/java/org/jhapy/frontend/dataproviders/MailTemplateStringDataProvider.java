...
@SpringComponent
@UIScope
public class MailTemplateStringDataProvider extends JHapyAbstractStringDataProvider<MailTemplateDTO>
  ...
  public MailTemplateStringDataProvider(QueryGateway queryGateway) {
    super(queryGateway);
  }

  @Override
  @Synchronized
  protected Stream<MailTemplateDTO> fetchFromBackEnd(Query<MailTemplateDTO, String> query) {
  ...
  @Override
  @Synchronized
  protected int sizeInBackEnd(Query<MailTemplateDTO, String> query) {
