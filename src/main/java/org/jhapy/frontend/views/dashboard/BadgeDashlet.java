...
private Span titleSpan;
    ...
    protected void initContent() {
        ...
        h2 = new H2();
        if ( getDashletContent() != null )
        h2.setText(getDashletContent());
    if (getDashletStatus().equals(BadgeDashletStatusEnum.REGULAR)) {
      ...
      titleSpan
          .getElement()
          .setAttribute("theme", "badge success");
      ...
      titleSpan.getElement().setAttribute("theme", "badge error");
        ...
        if ( getDashletDescription() != null )
            descriptionSpan.setText(getDashletDescription());
