...
import org.jhapy.frontend.customFields.DefaultCustomListFieldForTranslationV3;

import java.util.Map;

public class CustomListFieldValueChangeEventForTranslationV3<C extends EntityTranslationV2>
  ...
  private final DefaultCustomListFieldForTranslationV3 src;

  public CustomListFieldValueChangeEventForTranslationV3(
      Map<String, C> oldValues,
      Map<String, C> newValues,
      DefaultCustomListFieldForTranslationV3 src) {
