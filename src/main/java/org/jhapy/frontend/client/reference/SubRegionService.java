...
public interface SubRegionService {
  ...
  ServiceResult<List<SubRegionDTO>> findAll();

  @PostMapping(value = "/findAnyMatching")
  ServiceResult<PageDTO<SubRegionDTO>> findAnyMatching(@RequestBody FindAnyMatchingQuery query);

  @PostMapping(value = "/countAnyMatching")
  ServiceResult<Long> countAnyMatching(@RequestBody CountAnyMatchingQuery query);

  @PostMapping(value = "/getById")
  ServiceResult<SubRegionDTO> getById(@RequestBody GetByIdQuery query);

  @PostMapping(value = "/save")
  ServiceResult<SubRegionDTO> save(@RequestBody SaveQuery<SubRegionDTO> query);
