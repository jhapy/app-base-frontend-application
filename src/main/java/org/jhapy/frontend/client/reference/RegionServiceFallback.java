...
public class RegionServiceFallback implements RegionService, HasLogger {
  ...
  @Override
  public ServiceResult<List<RegionDTO>> findAll() {
  ...
  @Override
  public ServiceResult<PageDTO<RegionDTO>> findAnyMatching(FindAnyMatchingQuery query) {
  ...
  @Override
  public ServiceResult<RegionDTO> getById(GetByIdQuery query) {
  ...
  @Override
  public ServiceResult<RegionDTO> save(SaveQuery<RegionDTO> query) {
